...
# Flaga do odpalenia animacji po "Tak" tylko raz (na rerun)
...
st.markdown(
    ...
    <style>
      ...
      .btn-row {{
        ...
        margin-top: 12px;
        position: relative;
        height: 190px; /* arena dla uciekającego "Nie" */
      }}
    ...
    <div class="wrap">
      <div class="card" id="card">
        ...
        <div class="btn-row" id="arena">
          <button class="yes-btn" onclick="window.location.search='?ans=yes'">Tak</button>
    ...
    <script>
      ...
      function playDing() {{
        try {{
          ...
          o2.frequency.value = 1320;  // E6-ish
          ...
          // jeśli przeglądarka zablokuje autoplay — trudno :)
        }}
      }}
      ...
      function spawnHearts(durationMs=2200) {{
        ...
        const timer = setInterval(() => {{
          ...
          const left = rand(20, cardRect.width - 40);
      ...
      // if Streamlit tells us "yes clicked", fire FX
...
# Klik "Tak" przez query param
params = st.query_params
if params.get("ans") == "yes":
    st.session_state.yes_clicked = True
    st.session_state.fire_fx = True  # odpal animacje przy tym rerunie
    st.query_params.clear()
else:
    # po rerunie wyłączamy trigger, żeby nie odpalało w kółko
    st.session_state.fire_fx = False
